...
set_property TRIGGER_COMPARE_VALUE eq16'hAA00 [get_hw_probes picoevr_system_arch_i/ESS_OpenEVR/U0/i_evr_dc/i_upstream/rx_data -of_objects [get_hw_ilas -of_objects [get_hw_devices xc7z030_1] -filter {CELL_NAME=~"u_ila_0"}]]
...
write_hw_ila_data -csv_file {sw/test/iladata.csv} hw_ila_data_1
close_hw_manager
