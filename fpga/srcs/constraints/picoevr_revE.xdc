...
set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS33} [get_ports {o_LEMO_DIR[0]}]; # IO_L16P_T2_13
set_property -dict {PACKAGE_PIN P8   IOSTANDARD LVCMOS18} [get_ports {b_LEMO_IO[1]}];  # IO_L5N_T0_34
...
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports {o_LEMO_DIR[2]}]; # IO_L15P_T2_DQS_13
set_property -dict {PACKAGE_PIN M7   IOSTANDARD LVCMOS18} [get_ports {b_LEMO_IO[3]}];  # IO_L6N_T0_VREF_34
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports {o_LEMO_DIR[3]}]; # IO_L15N_T2_DQS_13
